...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // 1. ANIMASI LOGO BERNAPAS (Membesar-Mengecil)
    _logoController = AnimationController(
      vsync: this,
      duration: const Duration(seconds: 2),
    )..repeat(reverse: true); // Ulangi terus menerus (besar-kecil-besar...)
  ...
  void _startApp() async {
    await Future.delayed(const Duration(seconds: 4)); // Tahan 4 detik
    if (mounted) {
                ...
                ScaleTransition(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.primary.withOpacity(0.1), // Lingkaran tipis
                      shape: BoxShape.circle,
                    ),
                    child: const Icon(
                      Icons.account_balance_wallet_rounded, // Ikon Dompet
                      size: 60,
...
// --- WIDGET LOADING TITIK-TITIK (TETAP SAMA) ---
